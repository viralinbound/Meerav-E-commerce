...
const MIRA_DATA = {
  ...
  products: [
    ...
    {
      id: "p2",
      name: "Meerav Royal Bikaneri Moth Bhujia",
      category: "bhujia-sev",
      tag: "Heritage GI Tag",
      rating: 5.0,
      reviewsCount: 512,
      spiceLevel: "Classic Bikaneri (🌶️🌶️)",
    ...
    {
      id: "p19",
      name: "Meerav Golden Cornflakes Royal Mixture",
      category: "mixture-farsan",
      tag: "Crispy Crunch",
      rating: 4.8,
      reviewsCount: 260,
      spiceLevel: "Sweet & Savory (🌶️)",
      dietary: ["100% Veg", "Crispy Corn", "Zero Palm Oil"],
      image: "assets/images/pack_khatta_meetha.svg",
      description: "Sun-ripened crunchy cornflakes fried to perfection and tossed with roasted cashew splits, curry leaves, and raisins.",
      ingredients: "Cornflakes, Cashews, Peanuts, Raisins, Pure Groundnut Oil, Powdered Sugar, Rock Salt.",
    ...
    {
      id: "p22",
      name: "Meerav All-In-One Imperial Farsan",
      category: "mixture-farsan",
      tag: "Signature Blend",
      rating: 4.8,
      reviewsCount: 350,
    ...
    {
      id: "p24",
      name: "Meerav Masala Boondi Pearls",
      category: "mixture-farsan",
      tag: "Raita & Snack",
      rating: 4.8,
      reviewsCount: 230,
      spiceLevel: "Spicy Tangy (🌶️🌶️)",
    ...
    },
    {
      ...
      rating: 4.8,
      reviewsCount: 370,
      spiceLevel: "Extra Fiery (🌶️🌶️🌶️🌶️)",
    ...
    {
      id: "p56",
      name: "Meerav Double Roasted Nut Mixture",
      category: "mixture-farsan",
      tag: "Peanut & Chana",
      rating: 4.9,
      reviewsCount: 340,
      spiceLevel: "Spiced Masala (🌶️🌶️)",
      dietary: ["100% Veg", "High Protein", "Crunchy Nuts"],
      image: "assets/images/pack_kaju_mixture.svg",
      description: "Jumbo Gujarat peanuts and whole black Bengal grams roasted crisp and coated in chaat masala and rock salt.",
      ingredients: "Peanuts, Whole Bengal Gram, Cold Pressed Mustard Oil, Chaat Masala, Sendha Namak.",
    ...
    },
    {
      ...
      rating: 4.8,
      reviewsCount: 290,
      spiceLevel: "Hot Hing Masala (🌶️🌶️🌶️)",
    ...
    },
    {
      ...
      rating: 4.8,
      reviewsCount: 310,
      spiceLevel: "Tangy Chaat Masala (🌶️🌶️)",
    ...
    },
    {
      ...
      rating: 4.9,
      reviewsCount: 290,
      spiceLevel: "Zesty Peri Peri (🌶️🌶️🌶️)",
