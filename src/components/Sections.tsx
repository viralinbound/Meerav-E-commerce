...
export function Testimonials() {
  ...
  return (
    <section className="py-8 sm:py-10 lg:py-20 bg-gradient-to-b from-cream-50 to-cream-100">
        ...
        <div id="home-testimonials-grid" className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((t) => (
            ...
            >
              ...
              <p className="text-sm text-charcoal-600 leading-relaxed mb-4 line-clamp-4">
                "{t.text}"
              </p>
...
export function KitchenStories() {
  return (
    <section className="py-8 sm:py-10 lg:py-20 bg-cream-50">
      <div className="container-max section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  <h3 className="font-serif text-lg font-bold text-cream-50 mb-1 leading-tight">
                    {story.title}
                  </h3>
                  <p className="text-sm text-cream-200 line-clamp-2">{story.description}</p>
                </div>
              </div>
            </div>
          ))}
...
export function InstagramFeed() {
  return (
    <section className="py-8 sm:py-10 lg:py-20 bg-gradient-to-b from-cream-100 to-cream-50">
      <div className="container-max section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
          <a
...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="py-8 sm:py-10 lg:py-20 bg-cream-50">
      <div className="container-max section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
          <span className="inline-block px-4 py-1.5 bg-saffron-100 text-saffron-700 text-sm font-medium rounded-full mb-4">
            Questions & Answers
        ...
        <div id="home-faq-list" className="max-w-3xl mx-auto space-y-3">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="bg-white rounded-xl shadow-sm overflow-hidden border border-cream-200"
            >
              <button
                onClick={() => setOpenIndex(openIndex === idx ? null : idx)}
                className="w-full flex items-center justify-between p-5 text-left hover:bg-cream-100 transition-colors"
              >
                <h3 className="font-semibold text-charcoal-800 text-sm md:text-base pr-4">
                  {faq.question}
                </h3>
