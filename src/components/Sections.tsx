...
export function Testimonials() {
  ...
  return (
    <section className="py-0 lg:py-20 bg-gradient-to-b from-cream-50 to-cream-100">
...
export function KitchenStories() {
  return (
    <section className="py-0 lg:py-20 bg-cream-50">
      <div className="container-max section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
...
export function InstagramFeed() {
  return (
    <section className="py-0 lg:py-20 bg-gradient-to-b from-cream-100 to-cream-50">
      <div className="container-max section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
          <a
...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="py-0 lg:py-20 bg-cream-50">
      <div className="container-max section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
          <span className="inline-block px-4 py-1.5 bg-saffron-100 text-saffron-700 text-sm font-medium rounded-full mb-4">
            Questions & Answers
